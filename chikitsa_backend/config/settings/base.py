"""
Base settings for Chikitsa project.
Contains common settings shared across all environments.

Following SOLID principles:
- Single Responsibility: Each settings file handles one environment
- Open/Closed: Easy to extend with new environments
- DRY: Common settings in base, specifics in env files
"""
...
# Development uses an insecure default; production.py enforces env-based key.
...
# Application definition - Following Separation of Concerns
DJANGO_APPS = [
...
# JWT Settings — shorter lifetimes for healthcare security
SIMPLE_JWT = {
...
REST_AUTH = {
    ...
    'JWT_AUTH_COOKIE': 'chikitsa-access-token',
    'JWT_AUTH_REFRESH_COOKIE': 'chikitsa-refresh-token',
...
CHATBOT_CONFIG = {
    ...
    'SYSTEM_PROMPT': """You are Chikitsa AI, a helpful medical assistant. 
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='Chikitsa <noreply@chikitsa.com>')
